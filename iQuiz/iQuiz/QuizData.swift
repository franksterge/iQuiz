...
class QuizData: NSObject {
    ...
    open var options: [[[String]]] = []//general options that is updated in questionViewController updates once per topic
    open var answers: [[Int]] = []//general options that is updated in questionViewController
    open var usedAPI = false
